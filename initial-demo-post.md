...
〖社会服务赛道 + 社会公益〗匠单 CraftOrder Demo：非遗研学课程与体验接单工作台
...
体验者可以在 Demo 中完成一条完整流程：选择非遗项目，输入城市、目标客群、课时时长、人数上限和材料成本，页面会整理课程名称、建议定价、毛利空间、教学目标、学生任务卡、老师备课提醒、游客预约页和传播素材包。
...
我希望这个作品首先被理解成一个“真实可用的非遗研学业务工具”。它的重点在业务流程重构：课程能交付、价格能解释、预约能跟进、素材能发布。
...
用途：中国版 TRAE Work CN 初赛材料复核，确认提交材料、压缩包、截图清单和作品帖文案。
